...
<div align="center">
	<div  style="background-color:	#FFE4E1;=width:1500px;height:300px;border: 1px solid ;">
		...
		<form action="duojieguo.jsp" method="post" id="zongheform" target="bottom">
		<div>
				<a href="zonghe.jsp" target="top">重置条件</a>&nbsp;&nbsp;
				...
				<select name="sname">
								<option value ="pingtaimc" >平台名称</option>
								<option value ="pingtaibh">平台编号</option>
								<option value="pizhunwh">批准文号</option>
								<option value="jsly">技术领域</option>
								<option value="pingtaijb">平台级别</option>
				</select>
				...
				<tr>
					<td>
						<div id="hiddenDiv1" style="display:none;">
							...
							<select name="sname1">
								<option value ="pingtaimc" >平台名称</option>
								<option value ="pingtaibh" selected="selected">平台编号</option>
								<option value="pizhunwh">批准文号</option>
								<option value="jsly">技术领域</option>
								<option value="pingtaijb">平台级别</option>
							</select>
					...
					<td>
						<div id="hiddenDiv2" style="display:none;">
							...
							<select name="sname2">
								<option value ="pingtaimc" >平台名称</option>
								<option value ="pingtaibh" >平台编号</option>
								<option value="pizhunwh" selected="selected">批准文号</option>
								<option value="jsly">技术领域</option>
								<option value="pingtaijb">平台级别</option>
							</select>
		<!-- 					<input  placeholder="" type="text" / > -->
					...
					<td>
						<div id="hiddenDiv3" style="display:none;">
							...
							<select name="sname3">
								...
								<option value ="pingtaibh">平台编号</option>
								<option value="pizhunwh">批准文号</option>
								<option value="jsly" selected="selected">技术领域</option>
								<option value="pingtaijb">平台级别</option>
							</select>
		<!-- 					<input  placeholder="" type="text" / > -->
					...
					<td>
						<div id="hiddenDiv4" style="display:none;">
							...
							<select name="sname4">
								...
								<option value="pizhunwh">批准文号</option>
								<option value="jsly">技术领域</option>
								<option value="pingtaijb" selected="selected">平台级别</option>
							</select>
		<!-- 					<input  placeholder="" type="text" / > -->
