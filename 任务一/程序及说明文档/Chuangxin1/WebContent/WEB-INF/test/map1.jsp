                ...
                var option = {  
                        ...
                        myChart.on(ecConfig.EVENT.MAP_SELECTED, function (param){  
                            ...
                            option.series[1] = {  
                                ...
                                roam: true,  
                                data:[                                 	
                                	{name :'保定市' , value:<%=jibenDao.sumcity("保定市")%>},
                                	{name :'张家口市' , value:<%=jibenDao.sumcity("张家口市")%>},
                                	{name :'承德市' , value:<%=jibenDao.sumcity("承德市")%>},
                                	{name :'秦皇岛市' , value:<%=jibenDao.sumcity("秦皇岛市")%>},
                                	{name :'唐山市' , value:<%=jibenDao.sumcity("唐山市")%>},
                                     {name: '廊坊市', value:<%=jibenDao.sumcity("廊坊市")%>},
<%--                                      {name: '石家庄市', value:<%=jibenDao.sumcity("石家庄市")%>)} , --%>
										{name: '石家庄市',value: <%=jibenDao.sumcity("石家庄市")%>},
                                     {name: '衡水市', value:<%=jibenDao.sumcity("衡水市")%>},  
                                     {name: '邢台市', value:<%=jibenDao.sumcity("邢台市")%>},  
                                     {name: '邯郸市', value:<%=jibenDao.sumcity("邯郸市")%>},  
                                     {name: '沧州市', value:<%=jibenDao.sumcity("沧州市")%>}
...
<%--                                     {name: '保山市',value: <%=jibenDao.sumcity("宝山市")%>},   --%>
...
<%--                                     {name: '佛山市',value: <%=jibenDao.sumcity("佛山市")%>},   --%>
...
<%--                                     {name:'保定市',value:<%=jibenDao.sumcity(city[0])%>} --%>                                                    
<%--                                     {name:'<%=city[1]%>',value:<%=jibenDao.sumcity(city[1])%>}, --%>
<%--                                     {name:'<%=city[2]%>',value:<%=jibenDao.sumcity(city[2])%>} --%>
